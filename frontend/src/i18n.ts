...
export const SCORE_INFO = {
  pt: [
    ...
    { name: 'Ritmo',      desc: 'Baseado no seu WPM (palavras por minuto). A faixa ideal para oratória é 120–160 wpm.' },
  ...
  en: [
    ...
    { name: 'Rhythm',        desc: 'Based on your WPM (words per minute). The ideal range for public speaking is 120–160 wpm.' },
